    ...
    <div className="health-dashboard" style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <span style={{ fontWeight: 'bold', color: '#00d4ff', fontSize: '18px' }}>System Health</span>
        </div>
        
        {/* Close Tab Button - Inside the sidebar header */}
        <button
          onClick={handleClose}
          style={{
      ...
      <div style={{
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{ fontWeight: 'bold', color: '#00d4ff' }}>Health Status</span>
            <span 
              style={{ 
                fontSize: '12px',
